    ...
    if (idPatient) {
      ...
      setConsultation([
...

        {
          ...
          description:
            "Consulta de rotina anual em paciente Rex, cinco anos. Exame físico revelou: gengivite de grau 2, discreta opacidade no cristalino (início de catarata senil), peso estável. Ausculta cardíaca e pulmonar normais. Discutida a importância da higiene bucal diária e agendamento de um destartarização. Solicitados Exames Laboratoriais (Hemograma completo, Bioquímica e Urinálise) para avaliação metabólica e rastreio de doenças crônicas. Plano de exercícios recomendado devido à idade.",
          type: "Retorno",
      ...
      <div className="px-[7.85rem] sm:px-[8.5rem] md:px-[9.5rem] lg:px-[7rem]">
        <Link href="/" className="flex items-baseline w-full">
          <Image
            ...
            className="mr-[2rem] h-[0.9rem] sm:h-[1rem] md:h-[1.3rem] lg:h-[1.5rem]"
          />
